...
- (void)traverseSubviews:(UIView *)view {
    ...
    if (self.view.subviews.count > 0) {
        for (UIView *subview in view.subviews) {
            ...
            UIBezierPath *defaultCoverblePath = [UIBezierPath bezierPathWithRoundedRect:subview.bounds cornerRadius:5/*subview.layer.cornerRadius*/];
...
//            _viewCover = [UIView new];
//            _viewCover.backgroundColor = [UIColor whiteColor]; // 遮罩也是白色
            ...
            maskLayer.fillColor = [UIColor yellowColor].CGColor;//[UIColor colorWithRed:0.9333 green:0.9333 blue:0.9333 alpha:1].CGColor;//[UIColor redColor].CGColor;
...
//            animation.toValue = @[@0.6, @1.2, @1.5]; //终点帧
            // 视图添加动画
